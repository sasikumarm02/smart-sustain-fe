...
function Forms() {
  ...
  const wasteData = [
    ...
    {
      key: 3,
      title: 'Actions recommended in the completed SIAs',
      name1: 'ActionsCompletedSIAs',
    },
    {
      key: 4,
      title: 'Actions implemented in the completed SIAs',
      name1: 'ActionsImplementedSIAs',
    },
    {
      key: 5,
      title: 'SIA reports weblink',
      name1: 'SIAReportsWeblink',
    },
  ];
  ...
  const fieldNames = [
    'CommencedPeriod',
    'CompletedPeriod',
    'ActionsCompletedSIAs',
    'ActionsImplementedSIAs',
    'SIAReportsWeblink',
  ];
      ...
      <Row style={{ paddingTop: '10px' }}>
        <Col span={24}>
          <p className={Styles.breadCrumbMain}>
            Social /{' '}
            <span>
              Social Impact Assessment including Gender impact Assesment
            </span>{' '}
          </p>
        </Col>
      </Row>
