...
function Forms() {
  ...
  const wasteData = [
    {
      ...
      title1: 'Female',
      name1: 'SeniorManagementFemale',
      title2: 'Male',
      name2: 'SeniorManagementMale',
      title3: 'Total',
      name3: 'SeniorManagementTotal',
    },
    {
      key: 2,
      title: 'Middle management',
      name1: 'MiddleManagementFemale',
      name2: 'MiddleManagementMale',
      name3: 'MiddleManagementTotal',
    },
    {
      key: 3,
      title: 'Executive',
      name1: 'ExecutiveFemale',
      name2: 'ExecutiveMale',
      name3: 'ExecutiveTotal',
    },
    {
      key: 4,
      title: 'Total',
  ...
  const fieldNames = [
    'SeniorManagementFemale',
    'SeniorManagementMale',
    'SeniorManagementTotal',
    'MiddleManagementFemale',
    'MiddleManagementMale',
    'MiddleManagementTotal',
    'ExecutiveFemale',
    'ExecutiveMale',
    'ExecutiveTotal',
    'TotalFemale',
      ...
      <Row style={{ paddingTop: '10px' }}>
        <Col span={24}>
          <p className={Styles.breadCrumbMain}>
            Social / <span>Performance & career development reviews</span>{' '}
          </p>
        </Col>
      </Row>
                  ...
                  {wasteData.map((data: any, index: any) => {
                    ...
                    return (
                      <Row gutter={12} align="middle" key={index}>
                        <Col lg={9} className={Styles.allFormLabel}>
