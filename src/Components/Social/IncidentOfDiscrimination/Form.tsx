...
function Forms() {
  ...
  const wasteData = [
    {
      key: 1,
      title: 'Logged during the period',
      title1: 'Numbers',
      name1: 'LoggedPeriod',
    },
    {
      key: 2,
      title: 'Reveiwed and remediation plan implemented',
      name1: 'ReveiwedImplemented',
    },
    {
      key: 3,
      title: 'Reveiwed and no longer subject to action',
      name1: 'ReveiwedAction',
    },
  ];
  ...
  const fieldNames = ['LoggedPeriod', 'ReveiwedImplemented', 'ReveiwedAction'];
      ...
      <Row style={{ paddingTop: '10px' }}>
        <Col span={24}>
          <p className={Styles.breadCrumbMain}>
            Social / <span>Incidents of discrimination</span>{' '}
          </p>
        </Col>
      </Row>
