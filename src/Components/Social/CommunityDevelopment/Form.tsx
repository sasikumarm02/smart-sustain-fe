...
function Forms() {
  ...
  const wasteData = [
    ...
    {
      key: 3,
      title: 'No. of benefited persons in the completed Programs',
      name1: 'CompletedPrograms',
    },
    {
      key: 4,
      title: '% of beneficiaries from vulnerable and marginalized groups',
      name1: 'MarginalizedGroups',
    },
    {
      key: 5,
      title: 'Community Development Programs weblink',
      name1: 'CommunityDevelopment',
    },
    {
      key: 6,
      title: 'Consultative Committees details weblink',
      name1: 'ConsultativeCommittees',
    },
  ];
      ...
      <Row style={{ paddingTop: '10px' }}>
        <Col span={24}>
          <p className={Styles.breadCrumbMain}>
            Social / <span>Community Development Programs</span>{' '}
          </p>
        </Col>
      </Row>
