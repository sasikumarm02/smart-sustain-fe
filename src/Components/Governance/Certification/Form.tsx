...
function Forms() {
  ...
  const wasteData = [
    ...
    {
      key: 3,
      title: 'BCA Green Mark (Building Sustainability Index)',
      name1: 'eWasteUom',
    },
    {
      key: 4,
    ...
    {
      key: 5,
      title: "SG Clean (Singapore's cleanliness and hygiene certification)",
      name1: 'eWasteUom',
    },
  ];
      ...
      <Row style={{ paddingTop: '10px' }}>
        <Col span={24}>
          <p className={Styles.breadCrumbMain}>
            Social / <span>Certifications</span>{' '}
          </p>
        </Col>
      </Row>
            ...
            {({
              ...
              return (
                ...
                >
                  ...
                  {/* <Col span={9} style={{ paddingTop: "10px" }}>
                    <Button className={Styles.occupatioBtn} >+ Add  certificate</Button>
                  </Col> */}
