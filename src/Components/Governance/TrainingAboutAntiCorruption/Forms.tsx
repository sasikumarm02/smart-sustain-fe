...
function Forms() {
  ...
  const wasteData = [
    {
      ...
      name1: 'GovernanceMembers',
      title2: 'Training',
      name2: 'GovernanceMembers',
    },
    {
      key: 2,
      title: 'Senior Management',
      name1: 'SeniorManagement',
    },
    {
      key: 3,
      title: 'Middle Management',
      name1: 'MiddleManagement',
    },
    {
      key: 4,
      title: 'Executives',
    ...
    {
      key: 5,
      title: 'No.of Business Partners',
      name1: 'BusinessPartners',
    },
  ];
  const wasteDataIncident = [
    {
      key: 1,
      title: 'Public legal cases regarding corruption',
      title1: 'Numbers',
      name1: 'GovernanceMembers',
    },
    {
      key: 2,
      title: 'Number of incidents in which action taken against Employees',
      name1: 'SeniorManagement',
    },
    {
      key: 3,
  ...
  const items: TabsProps['items'] = [
    {
      key: '1',
      label: 'Communication and Training',
      children: (
        <>
          <Formik
            initialValues={{
              ...
              return (
                ...
                >
                  <Row className="form-grid" gutter={12}>
                    {/* <Typography.Text className={Styles.FormHeader}>Stationary Combustion</Typography.Text> */}
                    <Col span={24}>
                      <Formik
                        initialValues={{
                          GovernanceMembers: '',
                                  ...
                                  <Row gutter={12} align="middle" key={index}>
                                    ...
                                    <Col lg={6} className="center-label-input">
                                      <CustomInput
                                        ...
                                        touched={touched}
                                        value={
                                          values[data.name1 as keyof Values]
                                        }
                                        hook={handleChange}
                                        blur={handleBlur}
                                        status={
                                          (touched[
                                            data.name1 as keyof Values
                                          ] &&
                                            errors[
                                              data.name1 as keyof Values
                                            ] &&
          ...
          >
            {({
              ...
              return (
                ...
                >
                  <Row className="form-grid" gutter={12}>
                    {/* <Typography.Text className={Styles.FormHeader}>Mobile Combustion</Typography.Text> */}
                    <Col span={24}>
                      <Formik
                        initialValues={{
                          GovernanceMembers: '',
                  ...
                  {/* <Row justify="end">
                    <Col span={3} className={Styles.DisplayButton}>
                      <Form.Item>
                        <Button
                          type="primary"
                          size="middle"
      ...
      <Row style={{ paddingTop: '10px' }}>
        <Col span={24}>
          <p className={Styles.breadCrumbMain}>
            Governance / <span>Ethical Behavior</span>{' '}
          </p>
        </Col>
      </Row>
