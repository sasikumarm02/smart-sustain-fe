...
export const CategoryTwoTable: React.FC<{ setActiveView?: (view: string) => void }> = ({ setActiveView }) => {
  ...
  const columns = [
    ...
    { title: 'Capital Good', dataIndex: 'good', key: 'good' },
    { title: 'Value', dataIndex: 'value', key: 'value', render: () => <span>$25,000.00</span> },
    { title: 'UOM', dataIndex: 'uom', key: 'uom', render: () => <span>Units</span> },
  ...
  const tabBarExtra = (
    <div className="flex items-center gap-4 py-2">
      ...
      <button
        onClick={() => setActiveView && setActiveView('scope-three-cat2-form')}
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center text-sm">
        ...
        <span className="mx-2 text-gray-400">&gt;</span>
        <span className="text-[#036323] text-lg">Category 2</span>
      </div>
      ...
      <PageCardComponent customClass="p-0 overflow-hidden bg-white shadow-sm rounded-xl">
        ...
        <div className="p-6 pt-2">
          <TableComponent data={[{ status: 'APPROVED', good: 'Machinery' }]} columnHeader={columns} enableRowSelection={false} noText="No activity records found." />
        </div>
      </PageCardComponent>
    </div>
  );
};
export default CategoryTwoTable;
