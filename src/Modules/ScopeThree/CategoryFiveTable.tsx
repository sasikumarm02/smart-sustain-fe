...
export const CategoryFiveTable: React.FC<{ setActiveView?: (view: string) => void }> = ({ setActiveView }) => {
  ...
  const columns = [
    ...
    { title: 'Waste Type', dataIndex: 'waste_type', key: 'waste_type' },
    { title: 'Total Quantity', dataIndex: 'quantity', key: 'quantity', render: () => <span>250.00</span> },
    { title: 'UOM', dataIndex: 'uom', key: 'uom', render: () => <span>tonnes</span> },
  ...
  const tabBarExtra = (
    <div className="flex items-center gap-4 py-2">
      ...
      <button
        onClick={() => setActiveView && setActiveView('scope-three-cat5-form')}
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center text-sm">
        ...
        <span className="mx-2 text-gray-400">&gt;</span>
        <span className="text-[#036323] text-lg">Category 5</span>
      </div>
      ...
      <PageCardComponent customClass="p-0 overflow-hidden bg-white shadow-sm rounded-xl">
        ...
        <div className="p-6 pt-2">
          <TableComponent data={[{ status: 'APPROVED', waste_type: 'Plastic' }]} columnHeader={columns} enableRowSelection={false} noText="No activity records found." />
        </div>
      </PageCardComponent>
    </div>
  );
};
export default CategoryFiveTable;
