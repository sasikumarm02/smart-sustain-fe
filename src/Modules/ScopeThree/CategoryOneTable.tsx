...
export const CategoryOneTable: React.FC<{ setActiveView?: (view: string) => void }> = ({ setActiveView }) => {
    ...
    const columns = [
        ...
        { title: 'Total Quantity', dataIndex: 'quantity', key: 'quantity', render: () => <span>1,500.00</span> },
        { title: 'UOM', dataIndex: 'uom', key: 'uom', render: () => <span>kg</span> },
    ...
    const tabBarExtra = (
        <div className="flex items-center gap-4 py-2">
            ...
            <button
                onClick={() => setActiveView && setActiveView('scope-three-cat1-form')}
    ...
    return (
        <div className="space-y-4">
            <div className="flex items-center text-sm">
                ...
                <span className="mx-2 text-gray-400">&gt;</span>
                <span className="text-[#036323] text-lg">Category 1</span>
            </div>
            ...
            <PageCardComponent customClass="p-0 overflow-hidden bg-white shadow-sm rounded-xl">
                ...
                <div className="p-6 pt-2">
                    <TableComponent data={[{ status: 'APPROVED', material: 'Steel' }]} columnHeader={columns} enableRowSelection={false} noText="No activity records found." />
                </div>
            </PageCardComponent>
        </div>
    );
};
export default CategoryOneTable;
