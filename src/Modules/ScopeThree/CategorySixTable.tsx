...
export const CategorySixTable: React.FC<{ setActiveView?: (view: string) => void }> = ({ setActiveView }) => {
  ...
  const columns = [
    ...
    { title: 'Travel Type', dataIndex: 'type', key: 'type' },
    { title: 'Total Quantity', dataIndex: 'quantity', key: 'quantity', render: () => <span>1,200.00</span> },
    { title: 'UOM', dataIndex: 'uom', key: 'uom', render: () => <span>km</span> },
  ...
  const tabs = [
    { key: '1', tab: 'Fuel-based Method' },
    { key: '2', tab: 'Distance-based Method' },
    { key: '3', tab: 'Spend-based Method' },
  ];
  ...
  const tabBarExtra = (
    <div className="flex items-center gap-4 py-2">
      ...
      <button
        onClick={() => setActiveView && setActiveView('scope-three-cat6-form')}
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center text-sm">
        ...
        <span className="mx-2 text-gray-400">&gt;</span>
        <span className="text-[#036323] text-lg">Category 6</span>
      </div>
      ...
      <PageCardComponent customClass="p-0 overflow-hidden bg-white shadow-sm rounded-xl">
        ...
        <div className="p-6 pt-2">
          <TableComponent data={[{ status: 'APPROVED', type: 'Air Travel' }]} columnHeader={columns} enableRowSelection={false} noText="No activity records found." />
        </div>
      </PageCardComponent>
    </div>
  );
};
export default CategorySixTable;
