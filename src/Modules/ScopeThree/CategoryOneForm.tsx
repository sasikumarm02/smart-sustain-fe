...
export default function CategoryOneForm({ setActiveView }: { setActiveView?: (view: string) => void }) {
    ...
    const columns = [
        {
            ...
            render: (text: any, record: any, rowIndex: number) => (
                <SelectComponent options={[{ label: 'Steel', value: 'Steel' }, { label: 'Aluminum', value: 'Aluminum' }]} value="" placeHolder="Select" />
            )
        },
        {
            title: 'UOM*',
            ...
            key: 'uom',
            render: (text: any, record: any, rowIndex: number) => (
                <SelectComponent options={[{ label: 'kg', value: 'kg' }, { label: 'tonnes', value: 'tonnes' }]} value="" placeHolder="Select" />
            )
        },
        {
            title: 'Quantity*',
    ...
    return (
        <div className="space-y-4">
            <div className="flex items-center text-sm mb-4">
                ...
                <span className="mx-2 text-gray-400">&gt;</span>
                <span className="font-bold text-[#001D3D] text-lg cursor-pointer hover:text-[#036323]" onClick={() => setActiveView && setActiveView('scope-three-cat1')}>Category 1</span>
                <span className="mx-2 text-gray-400">&gt;</span>
            ...
            <PageCardComponent customClass="p-8 pb-4 bg-white shadow-sm rounded-xl">
                ...
                <div className="flex justify-end gap-3 pt-12 pb-4">
                    <button type="button" className="text-[#036323] font-bold text-sm px-6 py-2" onClick={() => setActiveView && setActiveView('scope-three-cat1')}>Cancel</button>
